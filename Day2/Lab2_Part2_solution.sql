...
percent equals 10% of his/her annual salary .Display each employee full name 
and his annual commission in an ANNUAL COMM column (alias).*/
select Fname+' '+Lname as fullname,Salary+ Salary*.10 as ANNUAL from Employee
/*5.Display the employees Id, name who earns more than 1000 LE monthly.*/
select SSN,Fname+' '+Lname as fullname,Salary from Employee where Salary>1000
/*6.Display the employees Id, name who earns more than 10000 LE annually.*/
select SSN,Fname+' '+Lname as fullname,Salary*12 as annually from Employee where Salary*12>10000
